...
function ShuffleIcon({ w, color, active }) {
  return (
    <svg
...
function RepeatIcon({ w, color, active }) {
  return (
    <svg
...
function VolumeIcon({ w, color, value }) {
  const volume_Off =
...
function LikeIcon({ w, color, active }) {
  const liked =
...
function ArrowRightIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
...
function ArrowLeftIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
...
function ListMusicIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
...
function AddListMusicIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
...
function AudioLineIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
...
function ChangeAccountIcon({ w, color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height={w || 24}
